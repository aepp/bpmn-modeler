...
var cmdHelper = require('bpmn-js-properties-panel/lib/helper/CmdHelper'),
    ...
    scriptImplementation = require('bpmn-js-properties-panel/lib/provider/camunda/parts/implementation/Script');

import {getBusinessObject} from 'bpmn-js/lib/util/ModelUtil';
import { getListenerType } from '../utils';
...
module.exports = function(group, element, bpmnFactory, options, translate) {
  ...
  group.entries.push(entryFactory.selectBox({
    ...
    selectOptions: function(element, node) {
      var eventTypeOptions = executionListenerEventTypeOptions;
  ...
  group.entries.push(entryFactory.selectBox({
    ...
    get: function(element, node) {
      var listener = getSelectedListener(element, node);
      let listenerType = getListenerType(listener);
      return {
        listenerType
      };
    },
